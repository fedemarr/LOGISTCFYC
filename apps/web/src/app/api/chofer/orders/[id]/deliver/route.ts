 ...
 * confirmación obligatoria. Empuja el estado a Tienda Nube igual que la
 * versión del panel (`/api/orders/:id/deliver`) — ver
 * `markOrderDeliveredByDriver`.
 * POST /api/chofer/orders/:id/deliver { evidenceBase64, evidenceMimeType }
 */
